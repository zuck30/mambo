  ...
  const sections = [
    {
      ...
      icon: <Scale className="text-[#FFFC00]" size={24} />
    },
    {
      id: "02",
      ...
      icon: <Gavel className="text-[#FFFC00]" size={24} />
    },
    {
      id: "03",
      ...
      icon: <Globe className="text-[#FFFC00]" size={24} />
    }
  ];
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-1px bg-white/10 border-y border-white/10 mb-32">
          {sections.map((section) => (
            <div key={section.id} className="p-12 bg-black hover:bg-white/[0.02] transition-colors relative group">
              ...
              <h2 className="text-3xl font-black italic uppercase tracking-tighter mt-2 mb-6 group-hover:text-[#FFFC00] transition-colors">{section.title}</h2>
