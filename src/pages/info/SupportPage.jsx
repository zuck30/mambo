  ...
  const contactMethods = [
    {
      ...
      icon: (
        <svg viewBox="0 0 100 100" className="w-16 h-16 drop-shadow-[0_0_12px_rgba(255,121,172,0.4)]">
          <circle cx="50" cy="50" r="40" fill="none" stroke="#C13D88" strokeWidth="2" strokeDasharray="10 5" />
          <path d="M30 50 Q50 80 70 50" fill="none" stroke="#C13D88" strokeWidth="4" strokeLinecap="round" />
          <circle cx="50" cy="45" r="5" fill="#C13D88" />
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 100 100" className="w-16 h-16 drop-shadow-[0_0_12px_rgba(255,121,172,0.4)]">
          <rect x="25" y="25" width="50" height="50" rx="4" fill="none" stroke="#C13D88" strokeWidth="3" />
          <path d="M25 40 H75 M25 55 H75 M25 70 H55" stroke="#C13D88" strokeWidth="2" />
        </svg>
      )
    }
  ];
        ...
        <section className="px-8 md:px-20 py-24 grid grid-cols-1 md:grid-cols-2 gap-1px bg-white/10 border-y border-white/10">
          {contactMethods.map((method, i) => (
            ...
            >
              ...
              <span className="text-[#C13D88] text-[10px] font-black tracking-[0.4em] uppercase">
                {method.label}
              </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-6xl md:text-8xl font-black italic uppercase tracking-tighter mb-10 leading-none">
                Reach <br /> <span className="text-[#C13D88]">Directly</span>
              </h2>
              <div className="space-y-12">
                <div className="group cursor-pointer">
                  <span className="text-[10px] font-black tracking-[0.4em] text-white/30 block mb-2 underline decoration-[#C13D88] underline-offset-8">EMAIL</span>
                  <p className="text-3xl md:text-5xl font-black italic tracking-tighter hover:text-[#C13D88] transition-colors">support@mambo.com</p>
                </div>
                <div className="group cursor-pointer">
                  <span className="text-[10px] font-black tracking-[0.4em] text-white/30 block mb-2 underline decoration-[#C13D88] underline-offset-8">OFFICE</span>
                  <p className="text-3xl md:text-5xl font-black italic tracking-tighter hover:text-[#C13D88] transition-colors">Dar Es Salaam, TZ</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[3rem] p-12 md:p-16 relative overflow-hidden">
              ...
              <div className="space-y-12">
                <div>
                  <h4 className="text-[#C13D88] font-black uppercase text-[10px] tracking-widest mb-3">Login & Security</h4>
                ...
                <div>
                  <h4 className="text-[#C13D88] font-black uppercase text-[10px] tracking-widest mb-3">Account Purge</h4>
