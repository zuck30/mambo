...
const LearnPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-[#ff79ac] selection:text-white overflow-x-hidden">
      {/* Dynamic Background */}
        ...
        <section className="h-screen flex flex-col items-center justify-center text-center px-6">
          ...
          >
            <h1 className="text-[15vw] leading-[0.8] font-black italic uppercase tracking-tighter mb-8">
              THE <span className="text-[#ff79ac]">VIBE</span> <br /> MANUAL
            </h1>
          ...
          {vibeSections.map((section, index) => (
            ...
            >
              ...
              <div className="relative max-w-2xl">
                <span className="text-[#ff79ac] font-black italic text-6xl opacity-20 block mb-2">{section.id}</span>
                ...
                <p className="text-lg md:text-xl text-white/60 font-medium leading-relaxed border-l-2 border-[#ff79ac]/30 pl-8">
                  {section.content}
                </p>
              </div>
            </motion.section>
      ...
      <footer className="relative z-10 py-20 px-8 flex flex-col md:flex-row justify-between items-center gap-8 border-t border-white/5">
        ...
        <div className="flex gap-8 text-[10px] font-black uppercase tracking-[0.3em] text-white/40">
          ...
          <a href="#" className="hover:text-[#ff79ac]">Privacy</a>
          <a href="#" className="hover:text-[#ff79ac]">Support</a>
        </div>
      </footer>
    </div>
  );
